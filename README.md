...
A self-contained Phase-1 Thai script-mastery PWA: phonics-first reading, tone derivation, misconception-based checks, useful survival language, spaced repetition, honest early-foundation pacing, a 45-minute depth-first course rhythm once enough material is live, and a focused token economy.
