...
function renderMarkdown(audit){
  ...
  lines.push('');
  lines.push("v8.2.2 repairs the actual first lesson for a zero-knowledge learner: an English-only six-step meaning map replaces the cold Thai gist test, six vendor-cue/learner-reply pairs teach English meaning before Thai, every pair has an explicit visual turn gap, and the complete exchange appears only after those pairs with separate speech turns and a 900ms pause between speakers. validateV822BeginnerConversationContracts brings the generated audit to 62 validators. The v8.2.1 conversation-first front door and isolated conversation state remain intact; the correction adds no SRS, mastery, blocker, required-route, streak, token, active-time or learner-state mutation, while device voice remains labelled a rough preview and authored Thai remains teacher-review pending.");
  lines.push('');
