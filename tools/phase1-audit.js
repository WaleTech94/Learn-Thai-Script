...
globalThis.__phase1Audit = (function(){
  ...
  const validators = [
    ...
    isolatedValidatorResult('v841ConversationTeaching', validateV841ConversationTeachingContracts)
  ];
  return {
